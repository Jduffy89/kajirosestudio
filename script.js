const products = [
  {id:'blanket', name:'Custom Blanket', category:'blankets', icon:'🧺', desc:'Our #1 seller — personalize it with photos, names, artwork, and more.', badge:'#1 Seller', variants:[['Baby — 30×40 in.',25],['Toddler / Throw — 40×50 in.',35],['Twin / Throw — 50×60 in.',45],['Full / Queen — 60×80 in.',55]]},
  {id:'onesie', name:'Baby Onesie', category:'clothing', icon:'👶', desc:'Personalized baby onesie for everyday wear, keepsakes, and gifts.', variants:[['0–3 Month',15],['3–6 Month',15],['6–9 Month',15],['9–12 Month',15],['1–2Y',15]]},
  {id:'kids-shirt', name:'Kids T-Shirt', category:'clothing', icon:'👕', desc:'Custom kids shirt with your photos, names, artwork, or theme.', variants:[['2Y',18],['3Y',18],['4Y',18],['5/6Y',18],['7/8Y',18],['10/12Y',18]]},
  {id:'adult-shirt', name:'Adult T-Shirt', category:'clothing', icon:'👚', desc:'Custom adult shirt designed around your request.', variants:[['Small',25],['Medium',25],['Large',25],['XL',25],['XXL',25],['XXXL',25]]},
  {id:'keychain', name:'Keychain', category:'accessories', icon:'🔑', desc:'Small personalized keepsake with your image or design.', variants:[['Standard',10]]},
  {id:'tumbler', name:'Stainless Steel Tumbler', category:'drinkware', icon:'🥤', desc:'Custom tumbler with optional accessory bundle.', variants:[['20 oz',20],['20 oz + accessories',25],['30 oz',30],['30 oz + accessories',35],['40 oz',40],['40 oz + accessories',45]]},
  {id:'water-bottle', name:'Water Bottle', category:'drinkware', icon:'💧', desc:'Custom 20–25 oz water bottle.', variants:[['20–25 oz',15]]},
  {id:'beach-towel', name:'Beach Towel', category:'accessories', icon:'🏖️', desc:'Personalized beach towel for trips, gifts, and family fun.', variants:[['Standard',20]]},
  {id:'drawstring', name:'Drawstring Bag', category:'bags', icon:'🎒', desc:'Small fits an iPad, medium can hold a football, large can hold a basketball.', variants:[['Small — 10×13 in.',15],['Medium — 13×16 in.',20],['Large — 16×20 in.',25]]},
  {id:'tote', name:'Tote Bag', category:'bags', icon:'👜', desc:'13×15 in. custom tote bag.', variants:[['13×15 in.',20]]},
  {id:'notebook', name:'Notebook', category:'accessories', icon:'📓', desc:'Personalized notebook. Final price confirmed during review.', variants:[['Pocket — 5.5×3.5 in.',null],['Medium Spiral — 5×8 in.',null]]},
  {id:'mousepad', name:'Mouse Pad', category:'accessories', icon:'🖱️', desc:'Custom desk and gaming mouse pads in multiple sizes.', variants:[['7×9 in.',15],['9×11 in.',20],['12×28 in.',25],['16×32 in.',28],['16×30 in.',30]]}
];
